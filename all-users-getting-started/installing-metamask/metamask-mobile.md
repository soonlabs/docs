...
_Our next step is to change to "Ethereum Main Network" over to the Shimmer EVM Testnet! Click the right button at the bottom of this page to go over to_ [_the tutorial that will show you how to add the Shimmer EVM Testnet in MetaMask._](metamask-mobile/adding-the-shimmer-evm-network-mobile.md)
